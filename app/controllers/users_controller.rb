        ...
        if current_user.profile.female?
            if current_user.profile.taiwan?
                ...
                if params[:username].present?
                  @profiles = @profiles.get_by_username params[:username].page(params[:page]).per(21)
                end
                
                if params[:occupation].present?
                  @profiles = @profiles.get_by_occpation params[:occupation].page(params[:page]).per(21)
                end
                
                if params[:height1].present?
                  @profiles = @profiles.get_by_height1 params[:height1].page(params[:page]).per(21)
                end
                
                if params[:height2].present?
                  @profiles = @profiles.get_by_height2 params[:height2].page(params[:page]).per(21)
                end
                
                if params[:age1].present?
                  @profiles = @profiles.get_by_age1 params[:age1].page(params[:page]).per(21)
                end
                
                if params[:age2].present?
                  @profiles = @profiles.get_by_age2 params[:age2].page(params[:page]).per(21)
                end
            else
